...
export default function Toolbar({
  ...
  const icon = "rounded-full flex items-center justify-center transition-all active:scale-95 bg-white/10 hover:bg-white/20";
  ...
  return (
    ...
    <div
      ref={barRef}
      data-toolbar-version="sketch-v1"
    ...
    >
      ...
      <div className="grid grid-cols-[auto_1fr_auto] items-center gap-2 mb-2">
        ...
        <button
          ...
          aria-label="Previous"
          title="Previous"
          className="rounded-lg bg-white/10 hover:bg-white/20 active:scale-95 h-12 w-[74px] md:w-[84px] px-3"
        >
        ...
        <div className="flex items-center justify-center gap-2">
          <button
            ...
            aria-label="Stop"
            title="Stop"
            className="rounded-lg bg-red-600/80 hover:bg-red-600 active:scale-95 text-white px-4 h-12"
          >

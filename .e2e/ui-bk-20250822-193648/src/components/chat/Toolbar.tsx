...
export default function Toolbar({
  ...
  const pill =
    "h-11 md:h-12 px-4 md:px-5 rounded-xl bg-white/10 hover:bg-white/20 " +
    ...
    >
      ...
      <div className="grid grid-cols-[auto_1fr_auto] items-center gap-3">
        ...
        <div className="grid grid-cols-5 md:grid-cols-6 grid-rows-2 place-items-center gap-2 md:gap-3">
          ...
          {/* Stop كحبة وسطية */}
          <button
            className="h-11 md:h-12 px-4 md:px-5 rounded-xl bg-red-600/90 hover:bg-red-600 text-white font-medium"
            onClick={onStop}
            aria-label="Stop"
            title="Stop"
          >
